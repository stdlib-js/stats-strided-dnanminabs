...
```javascript
dnanminabs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanminabs@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-strided-dnanminabs/tags). For example,

```javascript
dnanminabs = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanminabs@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var dnanminabs = require( 'path/to/vendor/umd/stats-strided-dnanminabs/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-strided-dnanminabs@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/stats-strided-dnanminabs.svg
[npm-url]: https://npmjs.org/package/@stdlib/stats-strided-dnanminabs

[test-image]: https://github.com/stdlib-js/stats-strided-dnanminabs/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-strided-dnanminabs/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/stats-strided-dnanminabs/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/stats-strided-dnanminabs?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/stats-strided-dnanminabs.svg
[dependencies-url]: https://david-dm.org/stdlib-js/stats-strided-dnanminabs/main
...
[deno-url]: https://github.com/stdlib-js/stats-strided-dnanminabs/tree/deno
[deno-readme]: https://github.com/stdlib-js/stats-strided-dnanminabs/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-strided-dnanminabs/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-strided-dnanminabs/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-strided-dnanminabs/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-strided-dnanminabs/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-strided-dnanminabs/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/stats-strided-dnanminabs/main/LICENSE
